      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-muted/50 text-xs mt-1.5">{personalInfo.role}</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-[13px] text-muted/50 hover:text-foreground transition-colors duration-300"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="mt-16 pt-8 border-t border-accent-subtle text-center">
